...
@Component
public class VippReplyMonitorService extends BaseService implements Runnable {
    private static final Logger logger = Logger.getLogger(VippReplyMonitorService.class);

	@Override
	@Resource(name="vippReplyQueues")
